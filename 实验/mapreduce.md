...
# 2、教学内容：
 ...
 导包：
 /usr/local/hadoop/share/hadoop/common 下的hadoop-common-3.x.x.jar和hadoop-nfs-3.x.x.jar
 /usr/lcoal/hadoop/share/hadoop/common/lib 下的所有jar包
 /usr/local/hadoop/share/hadoop/mapreduce 中的所有jar包
 /usr/local/hadoop/share/hadoop/mapreduce/libv 下的所有jar包
...
public class MergeSort {
    ...
    public static class Map extends Mapper<Object, Text, IntWritable, IntWritable>{
        ...
        public void map(Object key, Text value, Context context) throws IOException,InterruptedException{
            ...
            data.set(Integer.parseInt(text));  // 字符串转化为IntWriteable类型
